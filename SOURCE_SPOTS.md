...
| 128019 | kdrama | true | 겨울연가 | 중간 | 겨울연가 배경 |

> 128019 = 공사 TourAPI contentid(남이섬 · 주소 강원특별자치도 춘천시 남산면 · 법정동 51/110). venues.js에 없는
> 신규 스팟이라 venue id 대신 contentid를 키로 쓴다(바로 아래 주의 문단의 "TourAPI로 신규 스팟을 조회해 추가" 절차).
> 등급·근거 문구는 사용자 지시(2026-09-12)를 그대로 옮긴 것이며 상향하지 않는다.
