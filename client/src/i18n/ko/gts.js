...
export default {
  gts: {
    ...
    build: {
      ...
      // [V5-30] 앵커가 적은 라인(drama·anime)에서 추천 12곳 대부분이 배지 없는 연계 로컬로
      //   채워질 때 안내 — UT에서 "왜 무관한 곳이 나오나" 혼란 확인 후 추가.
      mixNotice: "체크 배지가 있는 카드만 확인된 K-콘텐츠 성지예요. 나머지는 하루 일정을 채워주는 주변 로컬 장소예요.",
    },
    route: {
      title: "나의 동선",
      listTitle: "방문 순서",
      ...
      networkNote: "옅은 선은 도시 전체의 K-콘텐츠 노선입니다. 그 위에 내 노선이 진하게 그려집니다.",
    ...
    stamp: {
      ...
      guestNotice: "게스트 체험이라 이번 화면에만 표시됩니다. 로그인하면 스탬프가 쌓입니다.",
    },
    checkout: {
      title: "확인 및 결제",
      summaryTitle: "나의 하루",
      ...
      guestNotice: "게스트로 체험 중입니다. 로그인 없이 진행되며 실제 결제와 계정 생성은 일어나지 않습니다.",
    },
  ...
  gtsIntro: {
    ...
    layer: {
      topLabel: "위층: K-콘텐츠 노선",
      topBody: "세 개의 라인이 춘천의 K-콘텐츠를 나릅니다. 근거가 확인된 곳만 역이 되므로, 라인이 기록보다 더 많이 주장하지 않습니다.",
      bottomLabel: "아래층: 실제 이동",
      bottomBody: "한국관광공사 데이터가 역 사이를 설계합니다. 방문 순서와 거리, 하루에 실제로 걸리는 시간까지.",
    },
    flow: {
      s1: { title: "내 라인을 찾습니다", body: "다섯 문항, 약 40초." },
      s2: { title: "내 노선을 탑니다", body: "역을 고르면 방문 순서가 지도 위에 그려집니다." },
      s3: { title: "찍고 완주합니다", body: "역에 있는 NFC 스티커를 태그해 여권에 스탬프를 찍습니다." },
    },
    start: "시작하기",
    skip: "건너뛰기, 이미 해봤어요",
  },
