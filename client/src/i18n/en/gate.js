...
export default {
  ...
  handsfree: {
    ...
    faq: {
      ...
      a2: "An established luggage-delivery partner runs the transport. K-Route handles the booking and the Chuncheon side, and your drop-off code works across both.",
