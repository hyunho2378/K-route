...
export default {
  home: {
    ...
    lines: {
      ...
      lead: "Chuncheon's K-content sits scattered as dots on a map. Cheongchun Line ties the checked ones into three lines you can actually ride, then plans the real bus and walking legs between them.",
      cta: "Start Cheongchun Line",
    ...
    evidence: {
      eyebrow: "Why Cheongchun Line",
      title: "The problem in numbers",
      solution: "Chuncheon has the K-content but not the route map. Cheongchun Line draws one: a 40 second quiz picks your line, checked spots become its stations, and Korea Tourism Organization data plans the legs between them.",
      items: {
    ...
    // [V5-15] 보조 도구 · 구 "Tour Builder" 카드는 Cheongchun Line가 주 피치를 가져가며 내려갔다(Travel Log 로 교체).
    services: {
      eyebrow: "Also here",
    ...
    proof: {
      ...
      cta: "See the proof",
      alt: "Cheongchun Line van on a real Chuncheon pilot run", // [V10] van-hero 이미지 대체 텍스트
    },
  },
  gate: {
  ...
  handsfree: {
    ...
    faq: {
      ...
      a2: "An established luggage-delivery partner runs the transport. Cheongchun Line handles the booking and the Chuncheon side, and your drop-off code works across both.",
